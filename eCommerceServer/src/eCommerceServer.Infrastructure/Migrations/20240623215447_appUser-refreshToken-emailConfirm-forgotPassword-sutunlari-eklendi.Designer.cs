...
namespace eCommerceServer.Infrastructure.Migrations
{
    ...
    [Migration("20240623215447_appUser-refreshToken-emailConfirm-forgotPassword-sutunlari-eklendi")]
    partial class appUserrefreshTokenemailConfirmforgotPasswordsutunlarieklendi
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eCommerceServer.Domain.Identity.UserAddress", b =>
                {
                    ...
                    b.HasOne("eCommerceServer.Domain.Identity.AppUser", "AppUser")
                        .WithMany()
